...
// shadcn/ui Carousel (Embla) — kept API-compatible, cartoon buttons
...
function CarouselPrevious({ className, ...props }: React.ComponentProps<typeof Button>) {
  ...
  return (
    <Button data-slot="carousel-previous" variant="outline" size="icon" className={cn("rounded-full", className)}
...
function CarouselNext({ className, ...props }: React.ComponentProps<typeof Button>) {
  ...
  return (
    <Button data-slot="carousel-next" variant="outline" size="icon" className={cn("rounded-full", className)}
